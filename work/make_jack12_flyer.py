...
def generate_mobile_scroll():
    ...
    programs = [
        ...
        ("JACK12オンライン塾", "550,000円（税込）", "とにかく学びたい方へ。グループオンライン講座で、ユダヤ人の原理原則レクチャー、信頼形成、自己ブランディングを体系的に学ぶ。", COLORS["red"]),
        ("JACK12 VIP塾", "3,300,000円（税込）", "一緒にビジネスをしたい方へ。マンツーマンで、原理原則、事業設計、海外王族・要人や日本企業経営者との交流機会の活かし方を深める。", COLORS["black"]),
    ]
    ...
    y += 42
    y = section(y, "TRUST 01", "国際親善・公式任命", "バリ島王様公認の名誉親善大使をはじめ、各国親善大使・国際プログラムでの招聘、出演、実行委員経験を持つことが信頼の土台です。")
    y = bullet_block(
        y,
        [
    ...
    next_y = ml(
        mm + 34,
        next_y,
        "掲載内容はご提供プロフィール・公開用素材に基づく紹介文です。人脈形成、商談成立、成果を保証するものではありません。",
        mf["small"],
        (190, 184, 174),
        mw - 2 * mm - 68,
        9,
...
def main():
    ...
    draw_price_card(
        ...
        "550,000円",
        "グループオンライン講座",
        "とにかく学びたい方へ。ユダヤ人の原理原則レクチャー、信頼形成、自己ブランディングを体系的に学ぶ。",
        COLORS["red"],
    )
    draw_price_card(
        draw,
        ...
        "3,300,000円",
        "マンツーマンセッション",
        "一緒にビジネスをしたい方へ。事業・ブランド・国際展開を個別に対話し、交流機会の活かし方を深める。",
        COLORS["black"],
    )
