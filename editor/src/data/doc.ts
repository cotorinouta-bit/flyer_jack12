...
const D: any = {
  ...
  programs: [
    ...
    { title: "講演依頼", price: "330,000〜550,000円（税込）", desc: "お金も人脈も何もなかったJACK12が、どのように世界のロイヤルファミリーや大企業の会長とのご縁を築き、12の顔を持つ経営者・外交官になったのか。その秘訣を公開・指導します。" },
    ...
    { title: "JACK12ショー依頼", price: "1,200,000円（税込）", desc: "世界の王様や貴族、大統領などに披露しているエンターテインメントと、世界で成果を生み出す原理原則を伝える時間です。人生のターニングポイントとなるきっかけを皆様へ届けます。" },
  ...
  flyerCards: [
    ...
    { title: "講演依頼", price: "330,000〜550,000円", tag: "税込 / 講演・指導", desc: "ご縁を築き、12の顔を持つ経営者・外交官となった歩みと原理原則を伝えます。" },
    ...
    { title: "JACK12ショー依頼", price: "1,200,000円", tag: "税込 / ショー・講演", desc: "国際舞台で披露してきたエンターテインメントと、成果を生み出す原理原則を一つの時間に。" },
  ...
  mediaImages: [
    ...
    { file: "IMG_8282 2.JPG", caption: "桜マジック", focal: { x: 0.5, y: 0.42 } },
  ],

  valueTitle: "JACK12と関わるメリット",
  valueIntro: "国際舞台、経営、教育、エンターテインメントの実体験を、自身の事業と人とのつながりに生かすための視点へ変えてお伝えします。",
  valueBullets: [
    { head: "世界基準の視点に触れる", body: "王族、要人、大企業の経営者と向き合ってきた経験から、信頼される考え方と振る舞いを学べます。" },
    { head: "人脈を事業の力へ変える", body: "誰とつながるかだけでなく、そのご縁を相手や場に合わせて適切に示し、次の機会へつなげる方法を整理します。" },
    { head: "自分と事業の見せ方を磨く", body: "プロフィール、言葉、登壇、発信を見直し、肩書きや実績が信頼として伝わる形へ整えます。" },
    { head: "行動と決断を前へ進める", body: "学びで終わらせず、今の課題に合わせて次の一手を具体化します。" },
  ],

  profileTitle: "12の顔を持つ唯一無二の存在",
  profileName: "地球平和エンターテイナーJACK12",
  profileRole: "",
  profileBody: "JACK12は一つの肩書きでは語れない存在です。エンターテイナー、国際外交、経営者、教育者などの活動をしていますが、目指す先はただ一つ、世界平和です。",
  profileFaces: [
  ...
  trust: [
    {
      code: "ACHIEVEMENTS", title: "親善大使の任命・受賞歴",
      ...
      bullets: [
        ...
        { head: "大阪・関西万博 EXPO 2025 出演", body: "万博をはじめ、リッツ・カールトン京都、リーガロイヤルホテル京都など、一流ホテルや式典での公演実績。" },
        { head: "競技・映画での受賞実績", body: "アジア国際大会で日本代表ファイナリストに選出。出演作『西成ゴローの4億円』は、ミラノ・ニース・マドリードなどの国際映画祭でグランプリを受賞。" },
      ],
      pairs: [{
  ...
  offerDetails: [
    {
      code: "SERVICE 01",
      title: "JACK12ピースコミュニティ",
      intro: "JACK12の理念と活動に継続して触れ、同じ志を持つ仲間とつながる入口です。",
      bullets: [
        { head: "入会金 12,000円（税込）", body: "初回登録時に必要です。" },
        { head: "月額 1,320円（税込）", body: "理念、活動、学びに継続して触れられます。" },
        { head: "こんな方へ", body: "まずはJACK12の世界観を知り、コミュニティから関わりたい方へ。" },
      ],
    },
    {
      code: "SERVICE 02",
      title: "単発・顧問",
      intro: "今の課題を個別に整理したい方、講演を通じて原理原則と実体験を届けたい企業・団体向けです。",
      bullets: [
        { head: "単発 顧問　120,000円（税込）", body: "事業、プロフィール、ご縁の活かし方を、必要なタイミングで個別に整理します。" },
        { head: "講演依頼　330,000〜550,000円（税込）", body: "お金も人脈も何もなかったJACK12が、どのように世界のロイヤルファミリーや大企業の会長とのご縁を築き、12の顔を持つ経営者・外交官になったのか。その秘訣を公開・指導します。" },
      ],
    },
    {
      code: "SERVICE 03",
      title: "JACK12オンライン塾 & VIP塾",
      intro: "体系的に学ぶグループ講座と、事業の組み立てまで個別に伴走する最上位プログラムです。",
      bullets: [
        { head: "JACK12オンライン塾　550,000円（税込）", body: "原理原則、信頼される考え方、自分の見せ方を、グループオンライン講座で順を追って学びます。" },
        { head: "JACK12 VIP塾　3,300,000円（税込）", body: "マンツーマンで、原理原則から事業の組み立て、海外の王族・要人や日本企業の経営者と出会う機会の生かし方まで掘り下げます。" },
      ],
    },
    {
      code: "SERVICE 04",
      title: "JACK12ショー依頼",
      intro: "世界の王様や貴族、大統領などに披露してきたエンターテインメントと、成功の原理原則を一つの時間にまとめて届けます。",
      bullets: [
        { head: "1,200,000円（税込）", body: "エンターテインメントと、世界で成果を生み出す原理原則を伝える時間です。" },
        { head: "人生の転機となる体験を", body: "驚きと学びを通じて、行動や決断を見直すきっかけを皆様へ届けます。" },
      ],
    },
    {
      code: "SERVICE 05",
      title: "スポンサー",
      intro: "JACK12の活動と世界平和への理念を大きく支援し、ともに国内外への展開を広げるための枠です。",
      bullets: [
        { head: "12,000,000円（税込）", body: "活動の趣旨と展開内容をご確認いただき、個別にご案内します。" },
        { head: "理念を、次の展開へ", body: "エンターテインメントと教育による世界平和の活動を、ともに広げたい企業・経営者の方へ。" },
      ],
    },
  ],
