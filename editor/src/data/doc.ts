...
const D: any = {
  ...
  profileBody: "バリ島の王様公認で「名誉親善大使」の称号を授かったエンターテイナーです。王族や国家元首、国際機関などとの接点を生かし、エンターテインメントを通じて国際親善や次世代教育、平和構築に取り組んでいます。",

  trust: [
    {
      code: "TRUST 01", title: "親善大使としての任命と受賞",
      intro: "バリ島の王様公認の名誉親善大使をはじめ、各国の親善大使や国際プログラムへの招聘、出演、実行委員、受賞歴。こうした積み重ねが信頼の支えになっています。",
      bullets: [
        { head: "バリ島名誉親善大使", body: "バリ島の王様公認。国際親善・文化交流に関わる活動の一環。" },
...
const rewriteScroll: Record<Tone, Partial<ToneCopy>> = {
  elegant: {
    h1: "誰と会うかで、仕事は変わる。",
    heroBody: "王族や国家元首、国際機関と渡り合ってきたJACK12。そのご縁の輪に、あなたも加わる。人とのつながりで事業を広げたい経営者が、学び、出会う場です。",
    forIntro: "誰と出会い、どう信頼され、どんな場に身を置くか。事業の伸びしろは、そこで大きく変わります。JACK12が国際舞台で培った、選ばれ紹介される作法。それを、あなたの事業へ。",
    forBullets: [
