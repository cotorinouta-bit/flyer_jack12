...
const D: any = {
  ...
  programs: [
    ...
    { title: "スポンサー", price: "12,000,000円（税込）", desc: "JACK12の活動や理念を大きく支援し、ともに世界平和へ向けた展開を広げたい方向けの枠です。" },
  ],
  flyerCards: [
    ...
    { title: "スポンサー", price: "12,000,000円", tag: "税込 / スポンサー", desc: "理念と活動を大きく支援し、ともに展開を広げる枠です。" },
  ],
