...
const D: any = {
  ...
  scrollMission: "ミッション ─ エンタメと教育で、世界に平和を",
  flyerMissionLabel: "Mission",
  flyerMissionText: "エンタメと教育で地球平和",
  ...
  scroll: {
    elegant: {
      ...
      h1: "誰と出会うかで、\n仕事の景色は変わる。",
      heroBody:
        "王族や国家元首、国際機関と渡り合ってきたJACK12のご縁。その輪の中で、人とのつながりを軸に事業を広げたい経営者が学び、出会う場です。",
      forTitle: "ご縁を、事業の力に変えたい方へ",
      forIntro:
        "誰と出会い、どう信頼され、どんな場に身を置くか。事業の伸びしろは、案外そこで決まります。JACK12が国際舞台で身につけてきた、人から選ばれ紹介されるための考え方と振る舞いを、あなたの事業に落とし込みます。",
      forBullets: [
        { head: "ご縁を、信頼に変える", body: "肩書きや実績を、押しつけがましくならずに信頼へつなげる。そのためのプロフィールと立ち居振る舞いを見直します。" },
        { head: "紹介される人になる", body: "一流の場で重んじられる礼節・第一印象・ご縁のつなぎ方を身につける。" },
        { head: "商品より先に、あなたが選ばれる", body: "商品ではなくあなた自身が選ばれる、写真・言葉・場づくりを磨く。" },
        { head: "経営者同士が深くつながる", body: "理念と信用が先にあれば、関係は売り込みなしでも続きやすい。その始め方を学びます。" },
      ],
    ...
    passion: {
      ...
      forTitle: "ご縁が、次の挑戦を押し上げる",
      forIntro:
        "誰と出会うかで流れは変わる。人とのつながりで道をひらいてきたあなたなら、肌で分かっているはずです。JACK12が世界の一流と築いてきたご縁を、今度はあなたの事業と仲間のために。",
      forBullets: [
        { head: "出会いの輪が、視野を広げる", body: "この輪に入ると、付き合う相手が変わり、見えてくるものも変わってきます。" },
        { head: "一流の現場が、自分を引き上げる", body: "世界の一流が当たり前にしている振る舞いを間近で知り、自分の立ち位置を一段引き上げます。" },
        { head: "同じ志の仲間とつながる", body: "夢と理念で結ばれた経営者の輪なら、売り込み抜きで深い関係を育てていけます。" },
        { head: "あなた自身が、選ばれる人になる", body: "写真・言葉・世界観を磨き、人から選ばれ、紹介される自分をつくる。" },
      ],
      whyTitle: "経営者が、ここに集まる理由",
      whyIntro:
        "値段で選ぶ場ではありません。誰と出会えるか、どんな仲間とつながれるか。JACK12が世界の第一線で積んだ実体験と、志を持った経営者が、ここに集まっています。",
      whyBullets: [
        { head: "世界の第一線で積んだ、生きた現場の知恵", body: "王族や要人を前にした式典、映画祭の舞台。そこで実際に起きたことを、余さず伝えます。" },
        { head: "肩書きを、信頼と求心力に", body: "実績を信頼につなげ、また会いたいと思われる話し方を身につけます。" },
  ...
  flyer: {
    elegant: {
      ...
      cardsSub: "雰囲気を知る、じっくり学ぶ、二人三脚で深める。ご縁の深め方は選べます。",
      footSub: "雰囲気を知る / じっくり学ぶ / 二人三脚で深める",
    },
    passion: {
      title: ["この出会いから、", "勝負が始まる。"],
      subtitle: "世界の一流と渡り合ってきたJACK12と、志を同じくする仲間が集う。ご縁から始まる学びの場です。",
      target: "人とのつながりを力に、もう一歩先へ進みたい経営者へ",
      cardsSub: "まず覗いてみる、本気で学ぶ、二人三脚で挑む。あなたに合う入り方を選べます。",
      footSub: "まず覗く / 本気で学ぶ / 二人三脚で挑む",
    },
  },

  forImage: { file: "IMG_8280 2.JPG", caption: "上質な場での対話や交流を意識したプログラムです", focal: { x: 0.43, y: 0.48 } },

  scrollProgramTitle: "ご縁の結び方は、3通り",
  scrollProgramIntro: "まず雰囲気を知る道、じっくり学ぶ道、二人三脚で取り組む道。\n今の目的に合わせて選べます。",
  flyerCardsTitle: "ご縁の結び方は、3通り",

  programs: [
    { title: "JACK12ピースコミュニティ", price: "月額 1,320円（税込）", desc: "まずJACK12の世界観に触れたい方へ。\n年間払い 14,400円（税込） / 年間払いの方が1,440円お得。" },
    { title: "JACK12オンライン塾", price: "550,000円（税込）", desc: "とにかく学びたい方へ。グループオンライン講座で、ユダヤ人に伝わる原理原則、人から信頼される考え方、自分の見せ方を順を追って学びます。" },
    { title: "JACK12 VIP塾", price: "3,300,000円（税込）", desc: "一緒にビジネスをしたい方へ。マンツーマンで、原理原則から事業の組み立てまで。海外の王族・要人や日本企業の経営者と出会う機会の生かし方も、一緒に掘り下げます。" },
  ],
  flyerCards: [
    { title: "ピースコミュニティ", price: "月額 1,320円", tag: "年間 14,400円（税込）", desc: "JACK12の理念・活動・学びに継続して触れる入口。年間払いは月額払いより1,440円お得。" },
    { title: "オンライン塾", price: "550,000円", tag: "グループオンライン講座", desc: "とにかく学びたい方へ。ユダヤ人に伝わる原理原則と、信頼の築き方、自分の見せ方をまとめて学べます。" },
    { title: "VIP塾", price: "3,300,000円", tag: "マンツーマンセッション", desc: "一緒にビジネスをしたい方へ。事業づくりやブランド、海外展開について個別に話し合い、ご縁の活かし方まで一緒に考えます。" },
  ],

  mediaTitle: "万博の舞台と、受賞歴",
  mediaIntro: "華やかな国際活動を支えているのは、メディア出演や受賞、公演といった、誰でも確かめられる実績です。",
  mediaBullets: [
    { head: "テレビ・ラジオ出演", body: "NHK Eテレ・MBS などのTV・ラジオに出演しています。" },
    { head: "大阪・関西万博 EXPO 2025 出演", body: "リッツ・カールトン京都、リーガロイヤルホテル京都ほか一流ホテル・式典での公演実績。" },
    { head: "競技マジックで日本代表", body: "アジア国際大会（深圳）日本代表ファイナリスト。日本マジック教育普及協会 理事・師範。" },
  ...
  profileTitle: "JACK12という人物",
  profileName: "JACK12",
  profileRole: "地球平和エンターテイナー / Global Peace Entertainer\nJACK12 GLOBAL HOLDINGS 合同会社 CEO",
  profileBody: "公式プロフィールによると、王様公認で「名誉親善大使」の称号を授かったエンターテイナーです。王族や国家元首、国際機関などとの接点を生かし、エンターテインメントを通じて国際親善や次世代教育、平和構築に取り組んでいます。",

  trust: [
    {
      code: "TRUST 01", title: "親善大使としての任命と受賞",
      intro: "バリ島王様公認の名誉親善大使をはじめ、各国の親善大使や国際プログラムへの招聘、出演、実行委員、受賞歴。こうした積み重ねが信頼の支えになっています。",
      bullets: [
        { head: "バリ島名誉親善大使", body: "バリ島王様公認。国際親善・文化交流の活動背景として紹介。" },
    ...
    },
    {
      ...
      intro: "王族関係者や各国大臣、国際式典、カンヌ、モナコなどの場で出演・披露してきました。公式プロフィールでも、こうした国際舞台での評価が大きな強みとされています。",
      bullets: [
        { head: "王族・貴族関係者の前で披露", body: "貴族・ハイアットファミリー御前披露において「王室勲章史上、世界最高峰のエンターテイナー」と評された実績として紹介。" },
        { head: "王族・国家元首に認められた活動背景", body: "王族、貴族、国家元首、大統領、国際機関より招請を受けた公式プロフィール上の国際活動。" },
      ...
      pairs: [
        ...
        {
          left: { file: "IMG_8217 2.JPG", caption: "スリランカ要人との会談・握手", focal: { x: 0.5, y: 0.32 } },
  ...
  flyerProfile: {
    label: "主宰者プロフィール",
    name: "JACK12",
    role: "地球平和エンターテイナー / JACK12 GLOBAL HOLDINGS合同会社 CEO",
    body: "王族や国際機関との国際親善をはじめ、教育やエンターテインメント、経営の現場で活動してきました。本プログラムでは、その実体験をもとに、参加者が事業と人とのつながりを深められるよう、対話と学びの時間を用意します。",
    thumbs: [
  ...
  footerLabel: "選ぶときの目安",
  footerNote: "各プログラムは内容・参加条件を確認のうえご案内します。人脈形成、商談成立、成果を保証するものではありません。価格はすべて税込表記です。",
  cta: {
...
const rewriteScroll: Record<Tone, Partial<ToneCopy>> = {
  elegant: {
    h1: "誰と会うかで、仕事は変わる。",
    heroBody: "王族や国家元首、国際機関と渡り合ってきたJACK12。その縁の輪に、あなたの席を。人とのつながりで事業を広げたい経営者が、学び、出会う場です。",
    forIntro: "誰と出会い、どう信頼され、どんな場に身を置くか。事業の伸びしろは、そこで決まります。JACK12が国際舞台で培った、選ばれ紹介される作法。それを、あなたの事業へ。",
    forBullets: [
      { head: "ご縁を、信頼に変える", body: "肩書きや実績は、並べるほど重くなります。相手の負担にならない出し方へ。プロフィールと立ち居振る舞いを見直します。" },
      { head: "紹介される人になる", body: "一流の場で大切にされる礼節、第一印象、縁のつなぎ方。その作法を、身につけます。" },
      { head: "商品より先に、あなたが選ばれる", body: "売るのは商品。でも、先に選ばれるのはあなた自身です。写真・言葉・場のつくり方を磨きます。" },
      { head: "経営者同士が、深くつながる", body: "理念と信用が先にあれば、関係は売り込みなしでも続きます。その始め方を、ここで。" },
    ],
  ...
  passion: {
    ...
    forIntro: "誰と出会うかで、流れは変わる。人とのつながりで道をひらいてきた。あなたなら、肌で分かるはず。世界の一流と築いた縁を、今度はあなたの事業と仲間へ。",
    forBullets: [
      { head: "出会いの輪が、視野を広げる", body: "輪に入れば、付き合う相手が変わる。見える景色も、変わる。" },
      { head: "一流の現場が、自分を引き上げる", body: "世界の一流が当たり前にする所作を、間近で知る。自分の立ち位置が、一段上がる。" },
      { head: "同じ志の仲間とつながる", body: "夢と理念で結ばれた経営者の輪。売り込みは要らない。関係は、育てて深くなる。" },
      { head: "選ばれる人に、自分がなる", body: "写真・言葉・見せ方を磨く。人から選ばれ、紹介される——そんな自分をつくる。" },
    ],
    whyIntro: "値段で選ぶ場じゃない。誰と会えるか、どんな仲間と組めるか。世界の第一線で積んだ実体験が、ここにある。",
    whyBullets: [
      { head: "世界の第一線で積んだ、生きた現場の知恵", body: "王族や要人を前にした式典、映画祭の舞台。そこで起きたことを、余さず伝える。" },
      { head: "肩書きを、信頼と求心力に", body: "実績を信頼につなげる。また会いたいと思われる話し方を、身につける。" },
      { head: "夢でつながる経営者の輪", body: "理念と本気で結ばれた仲間と、高め合いながら事業を広げる。" },
...
const rewriteFlyer: Record<Tone, Partial<FlyerToneCopy>> = {
  elegant: { title: ["誰と会うかで、", "仕事は変わる。"] },
  passion: {
    subtitle: "世界の一流と渡り合ってきたJACK12。志を同じくする仲間が集う。ご縁から始まる、学びの場。",
    cardsSub: "まず覗く、本気で学ぶ、二人三脚で挑む。入り方は、選べる。",
  },
};
